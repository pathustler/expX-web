    ...
    return (
        <>
            <div className="topsidebar">
                ...
                <div className='bottombar flex flex-col items-center'>
                    {thumbnails.map((item, index) => (
                        <button
                            onClick={() => setActive(index)}
                            className={active === index ? "active skill-container" : "skill-container"}
                            key={index}
                        >
                            <img
                    ...
                    {/* <button className='icon-button w-10 h-10 bg-navy-500 rounded-lg border-l-black mt-4'>
                        <CalendarIcon className="h-6 w-6 text-gray-300" />
                    </button>
                    <button className='icon-button w-10 h-10 bg-silver-self-300 rounded-lg border-l-black mt-2'>
